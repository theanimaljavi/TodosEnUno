...
public class AyudaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_ayuda, container, false);
        ibSalir = view.findViewById(R.id.ibCerrar);
        //ocultar el boton al albrir la ayuda
        jugarFragment.btnEnviar.setVisibility(View.INVISIBLE);

        ibSalir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //desocultar boton comprobar
                jugarFragment.btnEnviar.setVisibility(View.VISIBLE);
                //cerrar fragment ayuda
                getActivity().getSupportFragmentManager().beginTransaction().remove(getFragmentManager().findFragmentById(R.id.contenedorAyudaJugar)).commit();
            }
        });
